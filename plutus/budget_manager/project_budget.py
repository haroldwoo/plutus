...
class ProjectBudget:
    ...
    budget_amount - int - monthly budget amount in USD
    ...
    def __init__(self, project_dict, config_type, billing_account_id, default_pubsub_topic):
        ...
        if config_type == PLUTUS_CONFIG_TYPE_PROJECT:
            ...
            metrics.incr("error_count", tags=["type:misconfig", f"project_id:{self.project_id}",
